...
|---|---|
| 🌍 **3D Globe** | Spin a painted-from-real-map Earth, tap continents/countries to discover them (atmosphere glow, stars, day/night, fly-to) — now with **pulsing gold pins on the 16 world wonders** |
| 🏛️ **World Wonders** | Visit 16 famous places in hand-built 3D scenes — the Western Wall, Giza + Sphinx, the African savanna, the Eiffel Tower, the Great Wall, Machu Picchu, the Northern Lights, a penguin colony… each hiding **3 floating treasures** to find (48 total) |
...
| 🎓 **The Little School** | Seven learning games: **math** (counting/addition/subtraction with objects), **Hebrew letters with full nikud row**, **first reading** (read the pointed word, pick the picture), **clock reading**, **memory pairs**, a **finger-painting studio** and a **xylophone with play-after-me songs** |
...
| 🇮🇱 **Israel** | Discover 59 cities on the districts map |
| 🚀 **Solar System** | A **rebuilt cinematic launch** (metallic ship, layered flame with shock diamonds, smoke, Hebrew stage captions, soft-painted Earth from space), realistic planets, asteroid belt, comet, ISS, constellations (14 space objects) |
...
- `src/three/landmarkKit.ts` + `LandmarkScene.ts` — the 16 hand-built wonder sites (mood skies, painted grounds, animated doves/penguins/aurora/bus) and the visit engine with floating treasure pedestals.
...
- `src/data/landmarks.ts` — the 16 wonders with real coordinates, facts and 48 treasures.
