...
| 🛰️ **Space Station** *(new in 5.0)* | Explore an orbiting station room by room — cockpit, observation deck, lab, zero-g greenhouse, engine room, cargo bay and crew quarters. **28 tappable machines** with their own reactions (levers pull, probes launch, holograms spin, the robotic arm waves), floating zero-g props, Earth turning below, and surprise events: a passing comet, a meteor shower, a cargo ship sailing by |
| 🚗 **Land Journey** *(new in 5.0)* | Ride a **car, train or plane** around a living scenic loop — the vehicle drives itself past **36 tappable sights** (waterfalls, castles, a tunnel the train actually enters, volcanoes, hot-air balloons, a rainbow…). Spinning wheels, puffing smoke, whirling propeller, swaying trees, drifting clouds, circling birds, and a slow/fast speed toggle |
| 🤿 **Deep-Sea Expedition** *(new in 5.0)* | Dive as a **yellow submarine (headlights on!) or a diver** to 5 special places: a shipwreck, a kelp forest, a glowing crystal cave, a sunken city and hydrothermal vents with a research station. **30 finds** including missions — free a turtle from a net, clean plastic from the sea, pop open treasure chests — while whales, dolphins and a friendly giant squid pass in the blue |
...
| 📒 **Sticker album** | 39 collectible reward stickers with celebrations — including 5.0 badges for the station crew, drivers, train conductors, pilots and deep-sea explorers |
